...
#导入excel,获取其中数据
he = HandleExcel(datas_dir+"\\rum测试用例.xlsx","创建应用接入探针场景")
#cases列表存储工作表下所有用例
...
class NewApplication(unittest.TestCase):
    ...
    def test04_upload_Confoundfile(self):
        ...
        #files = {'confound_file':('web_react_js_map_03.zip',open('D:\AutoTest\RUM\src\TestDatas\web_react_js_map_03.zip', 'rb'),'application/x-zip-compressed')}
